...
echo "<body onload='loadAssignmentsForUser(\"$currUser\")'>";
?>
<ul>
    <li><a href="home.php">Home</a></li>
    <?php
    if(getEnrollment(phpCAS::getUser(), $conn) === "Student") {
        echo "<li><a href='' class='current'>View Assignments</a></li>
...
<script>
    ...
    function loadAssignmentsForUser(user_campus_id) {
        ...
        ajaxQuery.open("POST", "retrieve_student_assignments.php", true);
        ajaxQuery.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        ajaxQuery.send("user=" + user_campus_id);
    }
