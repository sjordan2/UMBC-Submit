...
$delstudent_sql_check = "SELECT * FROM Students WHERE umbc_name_id = '$student_to_delete';";
$result = $conn->query($delstudent_sql_check);
if($result->num_rows > 1) {
    echo "ERROR: There are multiple rows matching the same UMBC Name ID!";
} else {
    $delstudent_sql = "DELETE FROM Students WHERE umbc_name_id = '$student_to_delete';";
