...
$delextension_sql_check = "SELECT * FROM Extensions WHERE assignment = '$assignment' AND student_id = '$student_id'";
$result = $conn->query($delextension_sql_check);
if($result->num_rows > 1) {
    echo "ERROR: There are multiple rows matching the same Extension!";
} else {
    $delextension_sql = "DELETE FROM Extensions WHERE assignment = '$assignment' AND student_id = '$student_id'";
